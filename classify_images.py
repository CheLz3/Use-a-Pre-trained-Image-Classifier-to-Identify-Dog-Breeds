...
def classify_images(images_dir, results_dic, model):
    ...
    for key in results_dic:
      ...
      # Converts all characters within model_label to lowercase 
      # letters and then removes whitespace characters from the ends
      # of model_label
      ...
      if truth in model_label:
        comparison_list.extend([truth,model_label,1])

      # If not found then added to results dictionary as NOT a match(0) using
      # the extend function 
      else:
        comparison_list.extend([truth,model_label,0])
      
      results_dic[key] = comparison_list
